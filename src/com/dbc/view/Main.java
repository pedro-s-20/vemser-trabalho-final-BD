    ...
    public static void main(String[] args) {
        ...
        while (escolha != 9) {
            ...
            if (escolha == 0) {
                ...
                while (escolhaTipoDeCadastro != 9) {
                        ...
                        while (escolhacadastro != 9) {
                            ...
                            if (escolhacadastro == 0) {
                                ...
                                while (opcao != 9) {
                                    ...
                                    switch (opcao) {
                                        case 1:
                                            //com.dbc.model.Cliente pessoa = new com.dbc.model.Cliente();
                                            //com.dbc.model.Convenio convenio = new com.dbc.model.Convenio();
                                            ...
                                            System.out.println("com.dbc.model.Cliente adicionado com sucesso.");
                                        ...
                                        case 3:
                                            ...
                                            System.out.println("com.dbc.model.Cliente editado com sucesso.");
                                            break;
                                        case 4:
                                            ...
                                            System.out.println("com.dbc.model.Cliente removido com sucesso.");
                                            break;
                                        case 9:
                                            break;
                                        default:
                            ...
                            if (escolhacadastro == 1) {
                                ...
                                while (opcao != 9) {
                                    ...
                                    switch (opcao) {
                                        case 1:
                                            //com.dbc.model.Administrativo pessoa = new com.dbc.model.Administrativo();
                                            ...
                                            System.out.println("com.dbc.model.Administrativo adicionado com sucesso.");
                                            break;
                                        case 2:
                                        ...
                                        case 3:
                                            ...
                                            System.out.println("com.dbc.model.Administrativo editado com sucesso.");
                                            break;
                                        case 4:
                                            ...
                                            System.out.println("com.dbc.model.Administrativo removido com sucesso.");
                                            break;
                                        case 9:
                                            break;
                                        default:
                            ...
                            if (escolhacadastro == 2) {
                                //com.dbc.model.MedicoManipulacao medicoManipulacao = new com.dbc.model.MedicoManipulacao();
                                int opcao = 0;
                                while (opcao != 9) {
                                    ...
                                    switch (opcao) {
                                        case 1:
                                            //com.dbc.model.Medico pessoa = new com.dbc.model.Medico();
                                            //com.dbc.model.Especialidades especialidade = new com.dbc.model.Especialidades();
                    ...
                    if (escolhaTipoDeCadastro == 2) {
                        //com.dbc.model.EspecialidadesManipulacao especialidadesManipulacao = new com.dbc.model.EspecialidadesManipulacao();
                        int opcao = 0;
                        while (opcao != 9) {
            ...
            if (escolha == 1) {
                ...
                //ArrayList<com.dbc.model.Especialidades> listaDeEspecialidades = convenioManipulacao.;
                //ArrayList<com.dbc.model.Convenio> listaDeConvenios = new ArrayList<>();
